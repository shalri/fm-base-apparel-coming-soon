...
export default function ComingSoonComponent() {
  ...
  return (
    <div className="sm:absolute flex flex-col items-center justify-center text-center pb-[96px] sm:flex-row sm:justify-between sm:w-full sm:pb-0 sm:text-left">
      <SaturateImage
        className="h-[250px] w-full bg-cover bg-top sm:bg-center bg-no-repeat bg-[url(/images/hero-mobile.jpg)] sm:order-last sm:bg-[url(/images/hero-desktop.jpg)] sm:min-h-dvh sm:max-w-[42dvw] sm:w-full"
        alt="Hero Image"
      />
      {/* <section className="px-8 sm:max-w-[444px]"> */}
      {/* <section className="px-8 sm:max-w-[1175px] sm:mx-auto sm:pl-0 sm:pr-8"> */}
      <section className="px-8 sm:max-w-[1135px] sm:mx-auto sm:pl-0 sm:pr-8">
        <div className="sm:flex sm:flex-col sm:justify-center sm:items-center sm:w-[444px] sm:mx-auto">
          ...
          <form
            className={cn("sm:w-full mt-9 border border-ba-desaturated-red/30 rounded-full flex items-center justify-between h-12 flex-nowrap transition-color duration-300", hasError && "border-ba-soft-red")}
